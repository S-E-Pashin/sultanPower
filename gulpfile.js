...
gulp.task("sprite", function () {
  return gulp.src("source/img/{logo-*.svg,icon-*,htmlacademy*,*.svg}.svg")
...
// gulp.task("build", gulp.series("clean", "copy", "webp", "css", "sprite", 'webpackDev', "html"));
gulp.task("build", gulp.series("clean", "copy", "css", 'webpackDev', "html"));
